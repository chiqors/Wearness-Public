    ...
    <div class="card-body">   
        ...
        <div class="pl-lg-4">
            <div class="row">
                ...
                <div class="input-group input-group-alternative mb-3">                    
                    <input class="form-control @error('url') is-invalid @enderror" placeholder="Url youtube" name="url" type="url" required>
                ...
                <div class="input-group input-group-alternative mb-3">                    
                    <input class="form-control @error('title') is-invalid @enderror" placeholder="Title" name="title" type="text" required>
                ...
                <div class="form-group @error('desc') has-danger @enderror">
                    <textarea class="form-control form-control-alternative" name="desc" rows="10" placeholder="Desc ..."></textarea>
                    @error('desc')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-lg-12">
                        <button type="submit" class="btn btn-danger btn-sm mt-4 float-right">Submit</button>
                  </div>
            </div>        
        </div>               
        </form>
