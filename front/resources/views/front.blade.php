            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">{{ $home->title }}</h1>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">{{ $home->sub }}</p>                  

                </div>

                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="{{ url('/register') }}" class="form-box">
                    ...
                    <div class="form-group">
                      <a href="{{ url('/register') }}" class="btn btn-primary btn-pill">Sign up</a>                      
                    </div>
                  </form>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            <h2 class="text-black mb-4">{{ $program->title1 }}</h2>
            <p class="mb-4">{{ $program->sub1 }}</p>
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h2 class="text-black mb-4">{{ $program->title2 }}</h2>
            <p class="mb-4">{{ $program->sub2 }}</p>
        ...
        <div class="row mb-5 align-items-center">
          <div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
            <img src="/asset/images/undraw_teacher.svg" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            <h2 class="text-black mb-4">{{ $program->title3 }}</h2>
            <p class="mb-4">{{ $program->sub3 }}</p>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="{{ $dev->url.'/'.$value->photo }}" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">{{ $value->name }}</h3>
                <p class="position">{{ $value->expertise }}r</p>
                <p>{{ $value->quote }}</p>
              </div>
            </div>
          </div>        
